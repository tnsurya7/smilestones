...
export default function MCHATPage() {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('Screening Results', 15, yPos);
    yPos += 8;
    
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Total Score: ${totalScore} / 20`, 15, yPos);
    yPos += 6;
    ...
    MCHAT_QUESTIONS.forEach((q, index) => {
      if (yPos > pageHeight - 40) {
        ...
        doc.setFontSize(12);
        doc.setFont('helvetica', 'bold');
        doc.text('M-CHAT SCREENING REPORT (Continued)', pageWidth / 2, 20, { align: 'center' });
        yPos = 30;
        doc.setFontSize(9);
        doc.setFont('helvetica', 'normal');
      }
