...
export default function TeachingInstitutesPage() {
  const images = [
    '/Teaching Institutes/14 Oct 2017 (Kolaperumal Chetty Vaishnav Senior Secondary School)_sub4.jpg',
    '/Teaching Institutes/17 Sep (Dav Senior Secondary School Gopalapuram).jpg',
    '/Teaching Institutes/Dav Mogappair June 2024.jpg',
    '/Teaching Institutes/Dav Mogappair June 2024_sub2.jpg',
    '/Teaching Institutes/Dav Mogappair June 2024_sub3.jpg',
    '/Teaching Institutes/Dec 2017 Dav Gill Nagar.jpg',
    '/Teaching Institutes/Dec 2017 Dav Gill Nagar_sub2.jpg',
    '/Teaching Institutes/Oct 2017 (Kolaperumal Chetty Vaishnav Senior Secondary School).jpg',
  ];
              ...
              {images.map((image, index) => (
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden bg-gray-100">
                    <img
                      src={image}
                      alt={`Teaching Institutes Program - Photo ${index + 1}`}
