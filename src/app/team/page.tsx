        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <div key={member.name} className="service-card text-center p-6">
                {/* Profile Image */}
                <div className="w-20 h-20 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 bg-gradient-to-br from-blue-100 to-green-100 rounded-full flex items-center justify-center text-3xl md:text-4xl">
                  {member.image}
                </div>
                ...
                <p className="text-gray-600 text-xs md:text-sm mb-4">{member.specialization}</p>
