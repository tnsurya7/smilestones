export const DSM_QUESTIONS = {
  ...
  B1: {
    ...
    questions: [
      { id: 'b1_1', text: 'Stereotyped or repetitive speech' },
      { id: 'b1_2', text: 'Pedantic speech or unusually formal language' },
      { id: 'b1_3', text: 'Echolalia' },
      { id: 'b1_4', text: 'Jargon or gibberish' },
      { id: 'b1_5', text: 'Use of rote language' },
      { id: 'b1_6', text: 'Idiosyncratic or metaphorical language' },
      { id: 'b1_7', text: 'Pronoun reversal' },
      { id: 'b1_8', text: 'Refers to self by own name' },
      { id: 'b1_9', text: 'Preservative language' },
      { id: 'b1_10', text: 'Repetitive vocalizations' },
      { id: 'b1_11', text: 'Stereotyped or repetitive motor movements' },
      { id: 'b1_12', text: 'Repetitive hand movements' },
      { id: 'b1_13', text: 'Stereotyped or complex whole-body movements' },
      { id: 'b1_14', text: 'Abnormalities of posture' },
      { id: 'b1_15', text: 'Intense body tensing' },
      { id: 'b1_16', text: 'Unusual facial grimacing' },
      { id: 'b1_17', text: 'Excessive teeth grinding' },
      { id: 'b1_18', text: 'Repetitively puts hands over ears' },
      { id: 'b1_19', text: 'Perseverative or repetitive action / play / behavior' },
      { id: 'b1_20', text: 'Repetitive picking' },
      { id: 'b1_21', text: 'Stereotyped or repetitive use of objects' },
      { id: 'b1_22', text: 'Nonfunctional play with objects' },
      { id: 'b1_23', text: 'Lines up toys or objects' },
      { id: 'b1_24', text: 'Repetitively opens and closes doors' },
      { id: 'b1_25', text: 'Repetitively turns lights on and off' }
    ]
  },
  B2: {
